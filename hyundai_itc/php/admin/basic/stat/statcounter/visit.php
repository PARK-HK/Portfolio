			...
			<form class="form-inline" name="flist" method="get" >
				<div class="box-table-button">
					...
					<div class="btn-group" role="group" aria-label="...">
						...
						<button data-page-url="<?php echo admin_url($this->pagedir . '/domain'); ?>" class="btn btn-gray btn-sm statsubmit">도메인</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/browser'); ?>" class="btn btn-gray btn-sm statsubmit">브라우저</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/os'); ?>" class="btn btn-gray btn-sm statsubmit">운영체제</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/hour'); ?>" class="btn btn-gray btn-sm statsubmit">시간</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/week'); ?>" class="btn btn-gray btn-sm statsubmit">요일</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/day'); ?>" class="btn btn-gray btn-sm statsubmit">일</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/month'); ?>" class="btn btn-gray btn-sm statsubmit">월</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/year'); ?>" class="btn btn-gray btn-sm statsubmit">년</button>
					</div>
				</div>
			</form>
		...
		<div class="table-responsive">
			...
			<div class="box-info">
				...
				<div class="btn-group pull-right" role="group" aria-label="...">
					<a href="<?php echo element('listall_url', $view); ?>" class="btn btn-outline btn-gray btn-sm">전체목록</a>
				</div>
			</div>
		</div>
	</div>
