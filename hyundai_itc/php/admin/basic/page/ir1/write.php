...
<div class="a-content a02">
						...
						?>
						<input type="hidden" name="post_content" value="전자공고"/>
						...
						<table>
							...
							<tbody>
								<tr>
									<th><input type="text" name="post_title" id="post_title" value="<?php echo set_value('post_title', element('post_title', element('post', $view))); ?>" placeholder="제목을 입력해주세요."></th>
									<td>
									<?php
	...
	if ($('#char_count') && false) {
		if (char_min > 0 || char_max > 0) {
			...
			if (char_min > 0 && char_min > cnt) {
				alert('내목은 ' + char_min + '글자 이상 쓰셔야 합니다.');
				$('#post_content').focus();
				return false;
