...
?>
                <h2>전자공고<span>총 <?=$view['list']['total_rownum']?>건</span></h2>
                <div class="ban-list">
                    <h3 class="mt70">전체 전자공고 리스트</h3>
                    <div class="btn-area">
						...
						<button class="btn btn-blue btn-102" onclick="document.location.href='./ir1/write'">등록</button>
                    </div>
					<?php
                    ...
                    <table class="mt40">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-blue" onclick="document.location.href='./ir1/modify/<?php echo element('post_id', $result); ?>'">수정</button></td>
                            </tr>
							<?php
								}
							}
