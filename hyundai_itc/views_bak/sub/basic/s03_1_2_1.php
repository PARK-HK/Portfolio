<!--내용시작 -->
        <div class="sub sub03-1">
            ...
            <div class="sub-content" data-aos="fade-up">
                ...
                <div class="layout">
                    <div class="tab-btn">
                        <a href="" class="tab">제선</a>
                        <ul class="work-list">
                            <li class="on"><a href="javascript:;">제선</a></li>
                    ...
                    <div class="work-infor">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="2" scope="col">원료처리</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="2" scope="col">소결소성공정</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th>직무소개</th>
                                    <td>고로 내 원활한 코크스 연소를 위해 원료인 분철광석 및 부원료, 연료 등을 투입해 5-5mm의 소결광으로 제조하는 업무</td>
                                </tr>
                                <tr>
                                    <th>전공분야</th>
                                    <td>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="2" scope="col">코크스공정</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th>직무소개</th>
                                    <td>석탄을 로(爐)에 장입하여 공기를 차단시킨 후 외부에서 열을 가해 휘발분을 제거하고 괴로 만드는 업무</td>
                                </tr>
                                <tr>
                                    <th>전공분야</th>
                                    <td>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="2" scope="col">고로공정</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th>직무소개</th>
                                    <td>코크스를 연소하여 철광석을 환원, 용융시켜 용선을 생산하는 업무</td>
                                </tr>
                                <tr>
                                    <th>전공분야</th>
                                    <td>
