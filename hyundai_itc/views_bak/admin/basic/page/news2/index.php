...
<div class="a-content a03">
                <h2>ITC News<span>총 <?=$view['list']['total_rownum']?>건</span></h2>                
                <div class="ban-list">
                    <h3 class="mt70">전체 ITC News 리스트</h3>
                    <div class="btn-area">
						...
						<button class="btn btn-blue btn-102" onclick="document.location.href='./news2/write'">등록</button>
                    </div>
					<?php
                        ...
                        <tbody>
							...
							<tr>
                                ...
                                <td>
									...
									<a href="javascript:file_download('<?php echo base_url('/postact/download/'.$result['fuid'][0]['pfi_id']); ?>')" download class="down"><img src="../img/admin/ico-download.svg" alt="">다운로드</a>
									<?php }?>
                                </td>
                                <td><button type="button" class="btn btn-blue" onclick="document.location.href='./news2/modify/<?php echo element('post_id', $result); ?>'">수정</button></td>
                            </tr>
							<?php
								}
							}
